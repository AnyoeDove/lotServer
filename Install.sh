...
function Install()
{
  ...
  URLKernel='https://github.com/AnyoeDove/lotServer/raw/master/lotServer.log'
  AcceData=$(wget -qO- "$URLKernel")
  ...
  mkdir -p "${AcceTmp}/bin/"
  mkdir -p "${AcceTmp}/etc/"
  wget -qO "${AcceTmp}/bin/${AcceBin}" "https://github.com/AnyoeDove/lotServer/raw/master/${MyKernel}"
